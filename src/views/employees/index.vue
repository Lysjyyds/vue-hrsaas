<template>
  <div class="dashboard-container">
    ...
    <AssiignRole ref="refRole" :is-show.sync="isShow" :current-id="currentId" />
  </div>
</template>
...
import AssiignRole from '@/views/employees/components/assign-role'
...
export default {
  ...
  methods: {
    async editRole(id) {
      await this.$refs.refRole.getUserDetailById(id)
      this.currentId = id
      this.isShow = true
    },
    async exportToExcel() {
